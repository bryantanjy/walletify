<nav x-data="{ open: false }" class=" w-full z-50 bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex" >
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-8 sm:flex" >
                    <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" style="font-size: 16px; font-weight: bold;">
                        {{ __('Home') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-8 sm:flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-8 sm:flex">
                    <x-nav-link href="" :active="request()->routeIs('budegt')" style="font-size: 16px; font-weight: bold;">
                        {{ __('Budget') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-8 sm:flex">
