<div id="editAccountModal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <!--Modal Content-->
        <div class="modal-content relative p-4 text-center rounded-lg shadow sm:p-5" style="background-color: #E1F1FA">
                ...
                @if (isset($account))
                    <form id="edit-form" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <select name="account_type" id="account_type" class="rounded-md border-0"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="rounded-md border-0" name="account_name" id="account_name"
